...
import 'package:hvacr_tool_box/screens/settings.dart';
          ...
          child:SingleChildScrollView(
            ...
            children: [
              Container(
                width: 50,
                height: 50,
              child: CircleAvatar(child: Image(image: AssetImage("images/book_5.png")))),
              SizedBox(width:12),
              Text("Mohamed Ahmed" , style:TextStyle(color: Colors.black45 , fontSize:20))
            ],
          ),
                ),
                Divider(
                ...
                drawerCard(context, "images/logo_v_en_2.png", "Terms and Condetions" , 6),
                drawerCard(context, "images/logo_v_en_2.png", "Privacy policy" , 7),
...
Widget drawerCard( context , imageurl , text , id){
    return GestureDetector(
          onTap: (){
            switch(id){
              case 1 : Navigator.push(context, MaterialPageRoute(builder: (context) => MyProfile() ));break;
              case 2 : Navigator.push(context, MaterialPageRoute(builder: (context) => MyPlan() ));break;
              case 3 : Navigator.push(context, MaterialPageRoute(builder: (context) => Videos() ));break;
              case 4 : Navigator.push(context, MaterialPageRoute(builder: (context) => Settings() ));break;
              case 5 : Navigator.push(context, MaterialPageRoute(builder: (context) => AboutUs() ));break;
              case 6 : Navigator.push(context, MaterialPageRoute(builder: (context) => Terms() ));break;
              case 7 : Navigator.push(context, MaterialPageRoute(builder: (context) => PrivacyPolicy() ));break;
              case 8 : Navigator.push(context, MaterialPageRoute(builder: (context) => ContactUs() ));break;
            }
          },
          child: Column(
        children: [
          Container(
            ...
            child: Row(
              children: [
                Image(image: AssetImage(imageurl) , width: 20, height: 20,),
                SizedBox(width:12),
