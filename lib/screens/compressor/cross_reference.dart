...
import 'cross_Refrences_MultiResults.dart';

class CrossReference extends StatefulWidget{
  @override
  _CrossReferenceState createState() => _CrossReferenceState();
}

class _CrossReferenceState extends State<CrossReference> {
  List result=[];
  @override
           ...
           child:ListView.builder(
             ...
             itemBuilder: (context, index) {
               return GestureDetector(
                 onTap: (){
                   Navigator.push(context, MaterialPageRoute(builder: (context)=> CrossReferenceMultiRuslts("${result[index]['id']}",'${result[index]['model']}') ));
                 },
                                child: Column(
