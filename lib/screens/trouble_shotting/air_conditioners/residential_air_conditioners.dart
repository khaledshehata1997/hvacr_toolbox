...
class ResidentialAirCondition extends StatefulWidget {
  ResidentialAirCondition() : super();

  @override
  ResidentialAirConditionState createState() => ResidentialAirConditionState();
}

class ResidentialAirConditionState extends State<ResidentialAirCondition> {
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text("Residential Air Conditioners" ,
